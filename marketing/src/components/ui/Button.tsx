...
const variants: Record<Variant, string> = {
  primary:
    "bg-paper text-ink hover:bg-white focus-visible:outline-paper active:scale-[0.98]",
  secondary:
    "border border-hairline bg-transparent text-paper hover:border-paper/55 hover:bg-white/5 focus-visible:outline-paper active:scale-[0.98]",
};
