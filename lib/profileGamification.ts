  ...
  const catalog: ProfileBadge[] = [
    {
      id: 'first-sip',
      label: 'First Sip',
      description: 'Rated your first space',
      icon: '○',
    ...
    },
    {
      id: 'tasting-notes',
      label: 'Tasting Notes',
      description: 'Added 10 tags across spaces',
      icon: '✎',
    ...
    },
    {
      id: 'cafe-scout',
      label: 'Space Scout',
      description: 'Saved or logged 10 spaces',
      icon: '△',
    ...
    },
    {
      ...
      description: 'Worked from the same space 3 times',
      icon: '♥',
      unlocked: snapshot.hasTripleEngagementCafe,
    },
    {
      id: 'first-cafe-approved',
      label: 'Greenlit Space',
      description: 'First space suggestion approved',
      icon: '✓',
    ...
    },
    {
      ...
      label: 'Curator',
      description: '3 space suggestions approved',
      icon: '☕',
